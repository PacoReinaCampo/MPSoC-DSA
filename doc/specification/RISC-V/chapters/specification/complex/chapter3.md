...
Effective planning is a determining factor in producing software that satisfies the guidelines of this document. Guidance for the software planning process includes:
   ...
   1. The software plans should be developed at a point in time in the software life cycle that provides timely direction to the personnel performing the software development processes and integral processes. See also the guidelines of subsection 9.1.
...
#### Complex YES/NOT Gate

`INSERT HERE`

#### Complex AND/NAND Gate
...
### Complex Perceptron Neural Network
...
### Complex Feedforward Neural Network
...
### Complex Long Short Term Memory Neural Network
...
* Output Vector
  ...
  ![Complex Neural Turing Machine Top](assets/chapter3/accelerator_top.jpg){width=6cm}

  `INSERT HERE`

  ![Complex Neural Turing Machine Heads](assets/chapter3/accelerator_heads.jpg){width=6cm}

  `INSERT HERE`

  ![Complex Neural Turing Machine Addressing](assets/chapter3/accelerator_addressing.jpg){width=6cm}

  `INSERT HERE`

### Complex Differentiable Neural Computer Neural Network
...
* Output Vector
  ...
  ![Complex Differentiable Neural Computer](assets/chapter3/dnc.png){width=17cm}

  `INSERT HERE`

### Complex Attention Neural Network
...
* Value Vector
  ...
  ![Complex Transformer Inputs Vector](assets/chapter3/accelerator_inputs_vector.png){width=6cm}

  `INSERT HERE`

  ![Complex Transformer Multi Head Attention](assets/chapter3/accelerator_multi_head_attention.png){width=6cm}

  `INSERT HERE`

  ![Complex Transformer Scaled Dot Product Attention](assets/chapter3/accelerator_scaled_dot_product_attention.png){width=6cm}

  `INSERT HERE`

  ![Complex Transformer Decoder](assets/chapter3/accelerator_decoder.png){width=6cm}

  `INSERT HERE`

  ![Complex Transformer Encoder](assets/chapter3/accelerator_encoder.png){width=6cm}
...
### Complex von Neumann Architecture
...
## COMPLEX ADVANCED COMPUTER ARCHITECTURE
...
![SoC DefenseTech Dependences](assets/chapter3/dependences-soc-fintech.svg){width=10cm}

`INSERT HERE`

![SoC EnergyTech Dependences](assets/chapter3/dependences-soc-fintech.svg){width=10cm}
...
### Complex Multi-Processor System on Chip
