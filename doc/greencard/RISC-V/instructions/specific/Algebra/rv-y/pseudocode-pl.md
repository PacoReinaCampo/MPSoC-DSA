...
**OPCFG (Configuration Setting)**
  ...
  |:-----------|:---------------------------------------------------|:----------------------------|:------------------------------------------------------|
  | `ysetiyli` | `31=1 30=1 zimm10   zimm5 14..12=0x7 rd 6..0=0x57` | `ysetyli rd, rs1, ytypei`   | `rd = new yl, rs1 = AVL, ytypei = new ytype setting`  |
  | `ysetyli`  | `31=0 zimm11          rs1 14..12=0x7 rd 6..0=0x57` | `ysetiyli rd, uimm, ytypei` | `rd = new yl, uimm = AVL, ytypei = new ytype setting` |
  | `ysetyl`   | `31=1 30..25=0x0 rs2  rs1 14..12=0x7 rd 6..0=0x57` | `ysetyl  rd, rs1, rs2`      | `rd = new yl, rs1 = AVL, rs2 = new ytype value`       |
