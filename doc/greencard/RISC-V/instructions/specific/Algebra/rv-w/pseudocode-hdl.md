...
**OPCFG (Configuration Setting)**
  ...
  |:-----------|:---------------------------------------------------|:----------------------------|:------------------------------------------------------|
  | `wsetiwli` | `31=1 30=1 zimm10   zimm5 14..12=0x7 rd 6..0=0x57` | `wsetwli rd, rs1, wtypei`   | `rd = new wl, rs1 = AVL, wtypei = new wtype setting`  |
  | `wsetwli`  | `31=0 zimm11          rs1 14..12=0x7 rd 6..0=0x57` | `wsetiwli rd, uimm, wtypei` | `rd = new wl, uimm = AVL, wtypei = new wtype setting` |
  | `wsetwl`   | `31=1 30..25=0x0 rs2  rs1 14..12=0x7 rd 6..0=0x57` | `wsetwl  rd, rs1, rs2`      | `rd = new wl, rs1 = AVL, rs2 = new wtype value`       |
