...
def peripheral_dsa_mod(k, p):
  """Returns the k modulo p.
  This function returns k % p.
  p must be a prime.
  """
...
print("Modulo Input:", hex(k))

r = peripheral_dsa_mod(k, curve.p)

print("Modulo Output:", hex(r))
